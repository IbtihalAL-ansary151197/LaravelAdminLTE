...
<html lang="en">
    <head>
        ...
        <meta name="csrf-token" content="fUrdu32kPBIpQoRXMgc84708hVIqs3G6NxHC1a3L">
    ...
    <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
        ...
        <form method="POST" action="{{route('adminLoginPost')}}">
            <input type="hidden" name="_token" value="fUrdu32kPBIpQoRXMgc84708hVIqs3G6NxHC1a3L">
            <!-- Email Address -->
            <div>
    ...
    Password
            ...
            <div class="flex items-center justify-end mt-4">
                                    <a class="underline text-sm text-gray-600 hover:text-gray-900" href="http://localhost:8000/forgot-password">
